process.stdout.write("]2;Mohammad Maruf 🌐 Ultra Edition\\");
...
function compareVersion(_0x4542d3, _0x3e334e) {
  ...
  for (let _0x277be0 = 0x0; _0x277be0 < 0x3; _0x277be0++) {
    ...
    if (parseInt(_0x4a41a6[_0x277be0]) < parseInt(_0x44dbec[_0x277beob])) {
      return -0x1;
    }
  }
  return 0x0;
...
let subTitle = "GoatBot V2@" + currentVersion + "- Powered by Mohammad Maruf";
const subTitleArray = [];
    ...
    try {
      ...
      if (_0x288897["continue"]) {
        ...
        await async function _0x17ce99(_0x308145) {
          ...
          const _0x4da775 = isNaN(_0x5c463e)
            ? toptp(_0x5c463e.normalize("NFD").toLowerCase().replace(/[\u0300-\u036f]/g, '').replace(/[đ|Đ]/g, _0x56b697 => _0x56b697 == 'đ' ? 'd' : 'D').replace(/\(|\)|\,/g, '').replace(/ /g, ''))
            : _0x5c463e;
...
async function startBot(_0x3cad9e) {
  ...
  const fcaVersion = (() => {
    try {
      return JSON.parse(require("fs").readFileSync(require.resolve("@eryxenx/fca").replace(/index\.js$/, "package.json"), "utf8")).version;
    } catch {
      return "unknown";
    }
  })();

  log.warn("FCA", `Modified By Mohammad Maruf 😈 | @eryxenx/fca v${fcaVersion}`);
  ...
  (function _0x3592ba(_0x812929) {
    ...
    login({
          ...
          if (_0x2855c6.endsWith(".js")) {
            ...
            if ((_0x3148f8 == "change" || _0x3148f8 == "rename") && existsSync(process.cwd() + '/scripts/cmds/' + _0x2855c6)) {
              try {
                ...
                const _0xd57e6c = global.utils.loadScripts(
                  "cmds",
                  _0x2855c6,
                  log,
          ...
          if (_0x34e90d.endsWith(".js")) {
            ...
            if ((_0x114011 == "change" || _0x114011 == 'rename') && existsSync(process.cwd() + "/scripts/events/" + _0x34e90d)) {
              try {
                ...
                const _0x5a271f = global.utils.loadScripts(
                  "events",
                  _0x34e90d,
                  log,
                  global.GoatBot.configCommands,
      ...
      const _0x5a9173 = global.GoatBot.config.adminBot
        .filter(_0x47eecf => !isNaN(_0x47eecf))
        .map(_0x303660 => _0x303660 = _0x303660.toString());
      ...
      async function _0x290401(_0x570bf7, _0xb100c2) {
        if (_0x570bf7) {
          ...
          if (_0x570bf7.error == "Not logged in" || _0x570bf7.error == "Not logged in." || _0x570bf7.error == "Connection refused: Server unavailable") {
            const _safeErr2 = _0x570bf7 && typeof _0x570bf7 === 'object'
              ? { error: _0x570bf7.error || String(_0x570bf7) }
              : _0x570bf7;
            ...
            if (_0x570bf7 == "Connection closed." || _0x570bf7 == "Connection closed by user.") {
              ...
              const _safeErr = _0x570bf7 && typeof _0x570bf7 === 'object'
                ? { error: _0x570bf7.error || String(_0x570bf7), type: _0x570bf7.type }
                : _0x570bf7;
        ...
        if (
          ...
          !global.GoatBot.config.adminBot.includes(_0xb100c2.senderID)
        ) {
          if (
            !global.GoatBot.config.whiteListMode.whiteListIds.includes(_0xb100c2.senderID) &&
            !global.GoatBot.config.whiteListModeThread.whiteListThreadIds.includes(_0xb100c2.threadID) &&
            !global.GoatBot.config.adminBot.includes(_0xb100c2.senderID)
          ) {
            return;
          }
        ...
        const _0x2d2b35 = require('../handler/handlerAction.js')(
          _0x4d5048,
          _0xedf862,
          _0x5c414a,
          _0x1f9059,
